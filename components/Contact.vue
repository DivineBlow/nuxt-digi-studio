<template>
  <div>
    <form class="vue-form" @submit.prevent="submit">
      <p class="contact__head">Контакты</p>
      <fieldset>
        <legend class="form__legend">
          Оставьте заявку и мы вам перезвоним!
        </legend>
        <div class="box__field">
          <div class="form__input left-i">
        ...
        <div class="check__box">
          <label class="cont__check" for="checkbox">
            ...
            <span class="underline">персональных данных</span>
...
@media screen and (min-width: 320px) and (max-width: 757.99px) {
  .vue-form .box__field .left-i[data-v-115426d6] {
    margin-left: 0px;
  }
